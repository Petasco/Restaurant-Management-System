...
Title_lbl = Label(TopFrame, text='RESTAURANT MANAGEMENT SYSTEM', font=('arial', 30, 'bold'), bg='Orange', fg='Blue',
                  width=55)
...
def Receipt():
    global total
    global sum, priceofFood, priceofDrinks, priceofCakes
    fufu = int(txtfufu.get())
    frice = int(txtfrice.get())
    waakye = int(txtwaakye.get())
    jollof = int(txtjollof.get())
...
Konkonte = Checkbutton(foodFrame, text='Konkonte\tGhc 10', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
Gob3 = Checkbutton(foodFrame, text='Gari & Beans\tGhc 15', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
                   variable=gob3var, command=gob3fxn)
Gob3.grid(row=6, column=0, sticky=W)
Kelewele = Checkbutton(foodFrame, text='Kelewele\t\tGhc 10', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
                       variable=kelewelevar, command=kelewelefxn)
Kelewele.grid(row=7, column=0, sticky=W)
RiceBall = Checkbutton(foodFrame, text='Rice Ball\t\tGhc 10', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
fufuEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtfufu)
fufuEntry.grid(row=0, column=1)
friceEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtfrice)
friceEntry.grid(row=1, column=1)
waakyeEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtwaakye)
waakyeEntry.grid(row=2, column=1)
jollofEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtjollof)
jollofEntry.grid(row=3, column=1)
konkonteEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtkonkonte)
konkonteEntry.grid(row=4, column=1)
bankuEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtbanku)
bankuEntry.grid(row=5, column=1)
gob3Entry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtgob3)
gob3Entry.grid(row=6, column=1)
keleweleEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtkelewele)
keleweleEntry.grid(row=7, column=1)
riceballEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtriceball)
riceballEntry.grid(row=10, column=1)
kenkeyEntry = Entry(foodFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtkenkey)
...
Cocktail = Checkbutton(drinkFrame, text='Cocktail\t\tGhc 25', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
orange = Checkbutton(drinkFrame, text='Orange Juice\tGhc 20', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
Pineaple = Checkbutton(drinkFrame, text='Pineaple Juice\tGhc 25', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
Tampico = Checkbutton(drinkFrame, text='Tampico Juice\tGhc 10', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
                      variable=tampicovar, command=tampicofxn)
Tampico.grid(row=7, column=0, sticky=W)
Apple = Checkbutton(drinkFrame, text='Apple Juice\tGhc 25', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
Lemon = Checkbutton(drinkFrame, text='Lemon Juice\tGhc 20', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
cockEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtcock)
cockEntry.grid(row=0, column=1)
cokeEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtcoke)
cokeEntry.grid(row=1, column=1)
pepsiEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtpepsi)
pepsiEntry.grid(row=2, column=1)
orangeEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtorange)
orangeEntry.grid(row=3, column=1)
donEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtdon)
donEntry.grid(row=4, column=1)
pineapleEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtpineaple)
pineapleEntry.grid(row=5, column=1)
beetEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtbeet)
beetEntry.grid(row=6, column=1)
tampicoEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txttampico)
tampicoEntry.grid(row=7, column=1)
appleEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtapple)
appleEntry.grid(row=10, column=1)
redwineEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtredwine)
redwineEntry.grid(row=8, column=1)
lemonEntry = Entry(drinkFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtlemon)
...
vanilla = Checkbutton(cakesFrame, text='Vanilla\t\tGhc 35', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
black = Checkbutton(cakesFrame, text='Black Forest\tGhc 45', font=('times', 15, 'bold'), onvalue=1, offvalue=0,
...
cheeseEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtcheese)
cheeseEntry.grid(row=0, column=1)
iceEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtice)
iceEntry.grid(row=1, column=1)
pizzzaEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtpizzza)
pizzzaEntry.grid(row=2, column=1)
chocoEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtchoco)
chocoEntry.grid(row=3, column=1)
vanillaEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtvanilla)
vanillaEntry.grid(row=4, column=1)
spongeEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtsponge)
spongeEntry.grid(row=5, column=1)
bananaEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtbanana)
bananaEntry.grid(row=6, column=1)
redEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtred)
redEntry.grid(row=7, column=1)
blackEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtblack)
blackEntry.grid(row=10, column=1)
oreoEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtoreo)
oreoEntry.grid(row=8, column=1)
blueEntry = Entry(cakesFrame, font=('tahoma', 12, 'bold'), bd=2, width=3, state=DISABLED, textvariable=txtblue)
...
hampersvar = IntVar()
trainingvar = IntVar()
Checkbutton(servicesFrame,text='Event Management', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=eventvar).grid(row=0,column=0,sticky=W)
Checkbutton(servicesFrame, text='Hampers', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=hampersvar).grid(row=1,column=0,sticky=W)
Checkbutton(servicesFrame,text='Training in:\nCakes Descoration &\nPractical Cookery',variable=trainingvar, font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0).grid(row=2,column=0,sticky=W)
...
funvar = IntVar()
officevar = IntVar()
Checkbutton(ordersFrame,text='Local Dishes', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=localvar).grid(row=0,column=0,sticky=W)
Checkbutton(ordersFrame, text='Continetal Dishes', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=contivar).grid(row=1,column=0,sticky=W)
Checkbutton(ordersFrame,text='Lunch', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=lunchvar).grid(row=2,column=0,sticky=W)
Checkbutton(ordersFrame, text='Dinner', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=dinnervar).grid(row=3,column=0,sticky=W)
Checkbutton(ordersFrame,text='Wedding', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=wedvar).grid(row=4,column=0,sticky=W)
Checkbutton(ordersFrame, text='Funneral', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=funvar).grid(row=5,column=0,sticky=W)
Checkbutton(ordersFrame,text='Office Delivery', font=('tahoma',8,'bold'),bd=1,onvalue=1,offvalue=0,variable=officevar).grid(row=6,column=0,sticky=W)
...
# ------------------------------- Calculator Buttons -------------------------------------------------------------------
btn7 = Button(calFrame, text='7', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('7'))
btn7.grid(row=1, column=0)
btn8 = Button(calFrame, text='8', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('8'))
btn8.grid(row=1, column=1)
btn9 = Button(calFrame, text='9', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('9'))
btn9.grid(row=1, column=2)
btnplus = Button(calFrame, text='+', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('+'))
btnplus.grid(row=1, column=3)
# -------------------------------- Row 2 ----------------------------------
btn4 = Button(calFrame, text='4', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('4'))
btn4.grid(row=2, column=0)
btn5 = Button(calFrame, text='5', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('5'))
btn5.grid(row=2, column=1)
btn6 = Button(calFrame, text='6', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('6'))
btn6.grid(row=2, column=2)
btnminus = Button(calFrame, text='-', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('-'))
btnminus.grid(row=2, column=3)
# -------------------------------- Row 3 -------------------------------------
btn1 = Button(calFrame, text='1', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('1'))
btn1.grid(row=3, column=0)
btn2 = Button(calFrame, text='2', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('2'))
btn2.grid(row=3, column=1)
btn3 = Button(calFrame, text='3', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('3'))
btn3.grid(row=3, column=2)
btntimes = Button(calFrame, text='x', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('*'))
btntimes.grid(row=3, column=3)
# --------------------------------- Row 4 --------------------------------------
btn0 = Button(calFrame, text='0', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('0'))
...
btnDivide = Button(calFrame, text='/', font=('arial', 16, 'bold'), bd=6, width=5, command=lambda: buttonClick('/'))
